...
;* File Name          : startup_stm32f0xx_hd.s
;* Author             : MCD Appl&ication Team
;* Version            : V1.2.0RC2
;* Date               : 10-April-2013
;* Description        : STM32F0xx High Density Devices Devices vector table for 
;*                      EWARM toolchain.
...
__vector_table
        ...
        DCD     PVD_VDDUSB_LP_IRQHandler       ; PVD and VDD_USB through EXTI Line detect
...
WWDG_IRQHandler
        ...
        PUBWEAK PVD_VDDUSB_LP_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
PVD_VDDUSB_LP_IRQHandler
        B PVD_VDDUSB_LP_IRQHandler
